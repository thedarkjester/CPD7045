...
{
    [Serializable]
    public class ScrapeSessionDuplicateStatementReceived
    {
        ...
        public ScrapeSessionDuplicateStatementReceived(Guid scrapeSessionId, Guid customerId, Guid billingCompanyId)
        {
