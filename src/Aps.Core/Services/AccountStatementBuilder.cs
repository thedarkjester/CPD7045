...
namespace Aps.Core.Services
{
    public class AccountStatementBuilder
    {
        ...
        public AccountStatementBuilder(IEventAggregator eventAggregator, EventIntegrationService eventIntegrationService, CustomerByIdQuery customerByIdQuery, BillingCompanyByIdQuery billingCompanyByIdQuery)
        {
