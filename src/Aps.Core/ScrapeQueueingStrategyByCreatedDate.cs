...
{
    public class ScrapeQueueingStrategyByCreatedDate : IScrapeQueueingStrategy
    {
        ...
        public IEnumerable<ScrapingObject> GetQueue(List<ScrapingObject> runningElements, List<ScrapingObject> completedElements, List<ScrapingObject> allElements)
        {
            ...
            sortedScrapingQueueItemsWithoutCompletedScrapes = sortedScrapingQueueItemsWithoutCompletedScrapes.OrderBy(item => item.CreatedDate).ToList();
